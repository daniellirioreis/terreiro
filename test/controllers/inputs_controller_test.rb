...
class InputsControllerTest < ActionController::TestCase
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post :create, input: { date_input: @input.date_input, description: @input.description, member_id: @input.member_id }
    end
  ...
  test "should update input" do
    patch :update, id: @input, input: { date_input: @input.date_input, description: @input.description, member_id: @input.member_id }
    assert_redirected_to input_path(assigns(:input))
  end
